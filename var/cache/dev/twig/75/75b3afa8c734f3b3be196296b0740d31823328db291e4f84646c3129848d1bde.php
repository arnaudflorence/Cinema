    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["acteur"]) || array_key_exists("acteur", $context) ? $context["acteur"] : (function () { throw new Twig_Error_Runtime('Variable "acteur" does not exist.', 16, $this->source); })()), "nomActeur", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>PrenomActeur</th>
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>DateNaissanceActeur</th>
                <td>{{ acteur.dateNaissanceActeur ? acteur.dateNaissanceActeur|date('Y-m-d') : '' }}</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "acteur/show.html.twig", "C:\\Users\\Stagiaire\\Documents\\NetBeansProjects\\CinemaManager\\templates\\acteur\\show.html.twig");
    }
}
